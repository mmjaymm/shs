...
?>
    ...
    ?>
					<tr>
						...
						<td style = "text-align:center;"><?php echo $rowstud["reg_status"];?></td>
						<td style = "text-align:center;"><?php printf ("%s",strtoupper ($rowstud["yr_start"])."-".strtoupper ($rowstud["yr_end"]));?></td>
						<td style = "text-align:center;"><a href="student_subjects_details.php?shsid=<?php echo $rowstud['shs_id'];?>&advid=<?php echo $rowstud['advise_id'];?>" target = "_blank">details</a></td>
					</tr>
