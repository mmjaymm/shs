     ...
     <?php navbar('listof_student'); ?>
      ...
      <div class="content-wrapper">
       ...
       <section class="content">
			<div class="box">
				<form method = "POST" action = "student_table.php" id = "fil" target="frme">
					<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
					  <div class="panel panel-default">
						<div class="panel-heading box-header with-border" style="background-color: #f39c12;color:white;" role="tab" id="headingOne">
