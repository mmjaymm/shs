       ...
       <section class="content">
        <div class="box">
            <div class="box-header with-border" style="background-color: #555555;color:white;">
              <h3 class="box-title">List of Faculty Staff <small class="label bg-yellow" id="num_app"> <?php echo $num_fac;?></small></h3>
				...
				<div class="table-responsive">
				  <table id="tblusers" class="table table-bordered table-hover">
					...
					<tbody>
						...
						?>
							<tr>
								<td><a class="btn btn-flat btn-primary"  id="view" href="applicant_info.php?id=<?php echo $fetch_staff['u_id'];?>" data-toggle="tooltip" title="User ID">#<?php echo $fetch_staff['u_id'];?></a></td>
