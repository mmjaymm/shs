					...
					<form>
						<div class="col-lg-12">
							<div class="form-group">
								<label for="gradetxt" class="control-label col-lg-2">Username :</label>
								<label for="gradetxt" class="control-label col-lg-10"><i><?php echo $s_uname;?></i></label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								<label for="gradetxt" class="control-label col-lg-2">Faculty ID :</label>
								<label for="gradetxt" class="control-label col-lg-10"><i><?php echo $s_id;?></i></label>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								<label for="gradetxt" class="control-label col-lg-2">Name of Instructor :</label>
								<label for="gradetxt" class="control-label col-lg-10"><i><?php echo strtoupper($s_lname." ".$s_fname);?></i></label>
							</div>
						</div>
					</form>
				</div><br/>
