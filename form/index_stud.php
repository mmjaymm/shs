...
<div class="banner">
          ...
          <div class="caption">
            <div class="caption-wrapper">
              ...
              <h1 class="animated bounceInUp">Enrolment System and Automated Sectioning</h1>
              <p class="animated bounceInLeft">for Senior High School in City College of Tagaytay</p>
              </div>
            </div>
          </div>
</div>
