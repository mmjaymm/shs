	...
	session_start();
		...
		if(isset($_POST['btnreport'])){
			if(empty($_POST['date_app']) AND empty($_POST['strand'])){
				?>
					<script>
						window.location = "print_preview.php?opt=all";
					</script>
				<?php
				...
				?>
					<script>
						window.location = "print_preview.php?opt=date_val&date=<?php echo $ndate_app;?>";
					</script>
				<?php
				...
				?>
					<script>
						window.location = "print_preview.php?opt=strand&strand=<?php echo $strand;?>";
					</script>
				<?php
			}else{
				?>
					<script>
						...
						window.location = "listof_applicant.php";
					</script>
				<?php
			}
		}
	...
	<center>
		...
		<?php  while ($row=mysqli_fetch_assoc($result)) { ?> 
		  <tr>
			...
			<td style = "text-align:left;"><b><?php echo strtoupper($row["lname"]."</b>, ".$row["fname"]." ".$row["mname"]);?></td><td style = "text-align:center;"><?php echo $row["lrn_no"];?></td>
