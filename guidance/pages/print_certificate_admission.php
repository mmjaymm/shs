...
$pdf = new FPDF('L','mm',array(165,213));
...
/*$sql_assign = mysqli_query($con,"SELECT * FROM tblassignatory WHERE position = 'Guidance Councilor'");
$result_assign = mysqli_fetch_array($sql_assign);

$lname = $result_assign['lname'];
$fname = $result_assign['fname'];
$mname = $result_assign['mname'];
*/
...
$pdf->Image('../../images/sig4.png' , 145 ,120, 20 , 20,'PNG');
$pdf->Image('../../images/sig3.png' , 45 ,120, 20 , 20,'PNG');
$pdf->Cell(80,0, $fname.' '.$mname.'. '.$lname , 0,2,'C');
*/
/*$sql_assign1 = mysqli_query($con,"SELECT * FROM tblassignatory WHERE position = 'VP Administrative'");
$result_assign1 = mysqli_fetch_array($sql_assign1);

$lname1 = $result_assign1['lname'];
$fname1 = $result_assign1['fname'];
$mname1 = $result_assign1['mname'];
*/
