<?php include "../templates/templates.php"; 
	...
	$sql_sel=mysql_query("SELECT * FROM tblapplicant_schedule WHERE schedule_id=$id");
	$app_row=mysql_fetch_array($sql_sel);
					...
					<form role="form" data-toggle="validator" method="post" action="" class="form-horizontal">
						<div class="row">
							...
							<div class="form-group" >
								...
								<div class="col-sm-8">
									<input class="form-control" id="txtdate" name="txtdate" type="date" value="<?php echo $app_row['date']; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<select name="time" class="form-control" value="<?php echo $app_row['time']; ?>">
