									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><center><a class="btn btn-flat btn-primary" href="student_subjects_details.php?shsid=<?php echo $shsid;?>
													&adv_id=<?php echo $fetch_stud_en['advise_id'];?>" data-toggle="tooltip" target = "_blank" 
													title="Click to View Subjects"><i class="glyphicon glyphicon-pencil"></i> View Subject Details</center></a>
												</td>
												<td><center><a class="btn btn-flat btn-primary" target="_blank" 
													href="fpdf/print_regform.php?shsid=<?php echo $shsid;?>&advid=<?php echo $fetch_stud_en['advise_id'];?>&en_id=<?php echo $fetch_stud_en['enrolled_id'];?>" data-toggle="tooltip" title="Print Registration"><i class="glyphicon glyphicon-print"></i>  Print Registration Form</a></center></td>
											</tr>
										<?php  
										}
										?>
