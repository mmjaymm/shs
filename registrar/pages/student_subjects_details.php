       ...
       <section class="content">
        <div class="box">
			<div class="box-header with-border" style="background-color: #dd4b39; color:white;">
				...
				<a href="rog.php?shsid=<?php echo $shsid;?>&advid=<?php echo $advid;?>" class="btn btn-flat btn-primary pull-right" name="btnprint" data-toggle="tooltip"  title="Print Report">Print ROG</a>
            </div>
