...
function loaddata($tablename){
	...
	while($row=mysql_fetch_assoc($sel)){
		...
		if($tablename=="tblapplicant"){
			$data[] = array('<input type="checkbox" name="appid" id="appid" value='.$appid.'>',$appid,$lname,$fname,$mname,
																					$gender,$street,$city,$province,$date);
		}
		else if($tablename=="tblapplicant_validate"){
			$data[] = array('<input type="checkbox" name="appid" id="appid" value='.$appid.'>',$appid,$lname,$fname,$mname,
																					$remarks,$date_val);
		}
		else if($tablename=="tblapplicant_schedule"){
			$data[] = array('<input type="checkbox" name="appid" id="appid" value='.$appid.'>',$appid,$date,$time,$status);
		}
