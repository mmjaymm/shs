...
<?php function navbar($active){?>
        ...
        <!-- Logo -->
        <a href="dashboard.php" class="logo"><i class="glyphicon glyphicon-home"></i> Registrar Office</a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="../../bootstrap/dist/img/avatar2.png" class="img-circle" alt="User Image" />
                    <p>
                      Registrar
                    </p>
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            ?>
              <a href="student_search.php">
                <i class="glyphicon glyphicon-list-alt"></i> <span>Registration</span>
              </a>
            </li>
			
			  <?php if($active=="student_registered"){ 
              echo '<li class="active">';
            }
            else{
              echo '<li>';
            ...
            ?>
              <a href="student_registered.php">
                <i class="glyphicon glyphicon-list-alt"></i> <span>List of Registered Student</span>
              </a>
            </li>
            ...
            ?>
              <a href="listof_student.php">
                <i class="glyphicon glyphicon-list-alt"></i> <span>Reports of Enrolled Student</span>
              </a>
            </li>
